...
Listen to the click action on the map.
...
| extra | The additional parameters to pass to callback. | Any | - | - | No |
...
The function to be executed when the map component is clicked.
